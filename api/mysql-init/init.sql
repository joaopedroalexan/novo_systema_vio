CREATE DATABASE  IF NOT EXISTS `vio_jon` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `vio_jon`;
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
-- Host: localhost    Database: vio_jon
-- ------------------------------------------------------
...
INSERT INTO `compra` VALUES (1,'2024-11-14 19:04:00',1),(2,'2024-11-13 17:00:00',1),(3,'2024-11-12 15:30:00',2),(4,'2024-11-11 14:20:00',2),(5,'2025-05-12 10:51:22',3),(6,'2025-05-12 10:51:26',3),(7,'2025-05-12 13:10:03',4),(8,'2025-05-12 13:18:28',8),(9,'2025-05-12 13:25:22',7);
...
INSERT INTO `evento` VALUES (1,'Festival de Verão','evento de verao','2024-12-15 00:00:00','Praia Central',1),(2,'Congresso de Tecnologia','Evento de tecnologia','2024-11-20 00:00:00','Centro de convencoes',2),(3,'Show Internacional','Evento internacional','2024-10-30 00:00:00','Arena Principal',3),(4,'Feira cultural de inferno','Evento culturral com musica e gastronomia','2025-07-20 18:00:00','Teatro Central',1);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`alunods`@`%`*/ /*!50003 TRIGGER `ImpediraAlteraçãodeDatasdeEventosPassados` BEFORE UPDATE ON `evento` FOR EACH ROW begin   
...
INSERT INTO `ingresso_compra` VALUES (1,5,4,1),(2,2,5,1),(3,1,1,2),(4,2,2,2),(5,2,3,5),(6,2,3,6),(7,10,7,9);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`alunods`@`%`*/ /*!50003 TRIGGER `verify_date_event` BEFORE INSERT ON `ingresso_compra` FOR EACH ROW begin
...
--
-- Dumping events for database 'vio_jon'
--

--
-- Dumping routines for database 'vio_jon'
--
...
select e.data_hora into v_data_evento from ingresso i join evento e on i.fk_id_evento = e.id_evento where i.id_ingresso =  p_id_ingresso;

if date(v_data_evento) < curdate() then 
signal sqlstate '45000'
set message_text = "ERRO_PROCEDURE - O evento ja terminou, não ha como comprar ingresso."; 
end if;
...
-- Dump completed on 2025-05-12 14:09:07
